...
public class privateMailSend {
public boolean Send(String fromEmailAddress, String toEmailAddress,String password,String data) throws IOException
   ...
   // session.setDebug(true);
    ...
    try {
       ...
       // message.setText("This is actual message  good");
        ...
        incomeText.setContent(data, "text/html");
